...
function Bubbles(container, self, options) {
  ...
  this.typeInput = function(callbackFn) {
    ...
    inputWrap.className = "input-wrap d-flex"
    var inputText = document.createElement("textarea")
    inputText.setAttribute("placeholder", "Enter your text...")
    inputText.setAttribute("class", "form-control form-control-lg")
    inputText.setAttribute("rows", "1")
    
    var inputBtn = document.createElement("input")
    inputBtn.setAttribute("type", "button")
    inputBtn.setAttribute("class", "btn btn-primary m-1 ")
